...
public class ActionOptionsPanel extends PluginPanel
{
    ...
    static
    {
        ARROW_RIGHT_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "/util/arrow_right.png"));
        GITHUB_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "github_icon.png"));
        DISCORD_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "discord_icon.png"));
        PATREON_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "patreon_icon.png"));
        WIKI_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "wiki_icon.png"));
        IMPORT_ICON = new ImageIcon(ImageUtil.getResourceStreamFromClass(net.runelite.client.plugins.info.InfoPanel.class, "import_icon.png"));
    }
